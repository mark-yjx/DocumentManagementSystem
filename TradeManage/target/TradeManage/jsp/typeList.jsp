        ...
        <div class="widget widget-table action-table">
            <div class="widget-header">
                ...
                <button class="btn btn-primary"
                        onclick="showSearch('bookSearch')">分类查询</button>
                |<a href="<%=path %>/queryTypeBypage.do">刷新</a>
            </div>
            <!-- /widget-header -->
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <c:forEach items="${logList }" var="list">
                        <tr>
                            ...
                            <td><a href="" role="button" class="btn"
                                   data-toggle="modal"
                                   onclick="showDia('myModal','${list.id }','${list.name }',)">修改</a>
                                |<a href="<%=path %>/deleteLogByid.do?id=${list.id }"> 删除</a></td>
                        </tr>
                    ...
                    <tr>
                        <td colspan="5">
                            ...
                            <c:if test="${page.pageNumber!=1 && page.totalPage!=0 }">
                                <a href="<%=path %>/queryTypeBypage.do?pageNumber=1">首页</a>
                                <a href="<%=path %>/queryTypeBypage.do?pageNumber=${page.pageNumber-1 }">上一页 </a>
                            </c:if>
                            ...
                            <c:if test="${page.pageNumber!=page.totalPage && page.totalPage!=0 }">
                                <a href="<%=path %>/queryTypeBypage.do?pageNumber=${page.pageNumber+1 }">下一页 </a>
                                <a href="<%=path %>/queryTypeBypage.do?pageNumber=${page.totalPage }">尾页</a>
                            </c:if>
                        </td>
                    </tr>
                    </tbody>
...
<div id="bookSearch" class="modal hide fade" tabindex="-1"
    ...
    <div class="modal-body">
        <div class="content clearfix">
            ...
            <form action="<%=path %>/queryTypeBypage.do" method="post" id="searchForm">

                <table class="table table-striped table-bordered">
                    <tr>
                        <td>分类名称</td>
                        <td><input type="text" id="opContent" name="name"
                            value="" placeholder="请输入需要查询的分类名称" class="login" /></td>
                    </tr>
                </table>
            </form>
        </div>
